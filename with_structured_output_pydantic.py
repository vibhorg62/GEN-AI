...
class Review(BaseModel):
    key_themes:list[str] = Field(description="A list of the main themes or topics discussed in the review.")
    summary:str = Field(description="A brief summary of the review.")
    sentiment:Literal["mazedaar jhakkaas", "ganda ekdum", "noormaal"] = Field(description="The overall sentiment of the review")
    pros:Optional[list[str]] = Field(description="A list of positive aspects or advantages mentioned in the review.")
    cons:Optional[list[str]] = Field(description="A list of negative aspects or disadvantages mentioned in the review .")
